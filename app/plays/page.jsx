...
export default async function PlaysPage() {
  ...
  .texts .ruled li{display:grid;grid-template-columns:220px 1fr;gap:28px;align-items:start;padding:28px 0;}
  .cover-link{display:block;width:220px;max-width:100%;}
  .text-cover{display:block;width:100%;height:auto;border:1px solid var(--ink);box-shadow:4px 5px 0 oklch(0.22 0.02 300 / .14);}
  ...
  @media(max-width:600px){.texts .ruled li{grid-template-columns:1fr;gap:18px}.cover-link{width:min(220px,70vw)}}
`}</style>
      <main>
