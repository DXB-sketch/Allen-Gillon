...
export default function DeliveryPage() {
  return <main className="wrap checkout-wrap"><h1 className="script">Delivery & payment</h1><div className="prose">
    ...
    <h2>Before checkout opens</h2><p>Stripe checkout will be added after Allen&rsquo;s products are set up in his account. Until then, text Allen to ask about a painting.</p>
