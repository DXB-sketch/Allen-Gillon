...
export const metadata = {title:"Ann's Art · Allen Gillon",description:"Original paintings by Ann Gillon, from Australian landscapes and seascapes to animals and colourful imaginings. AUD $100–$250, with free delivery in Australia."};
export default async function AnnsArtPage() {
  ...
  return <main><header className="pagehead"><div className="wrap">
    ...
    <p className="plain">When she is not singing, Ann paints. Explore her originals, from Australian landscapes and the sea to animals, music and colourful imaginings.</p>
  ...
  <section aria-label="Paintings by Ann"><div className="wrap">
